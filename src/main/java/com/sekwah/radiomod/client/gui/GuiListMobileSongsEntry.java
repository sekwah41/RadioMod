...
public class GuiListMobileSongsEntry implements GuiListExtended.IGuiListEntry
{
    private static final Logger LOGGER = LogManager.getLogger();
    private final Minecraft client;
    private final GuiMobile guiMobile;
    private final GuiListMobileSongs containingListSel;
    private final String songAuthor;
    private final String songTitle;
    private float hoverAnimation = 0;
    private final int index;
    
    public GuiListMobileSongsEntry(GuiListMobileSongs listPacksSelIn, String authorIn, String titleIn)
    {
        this.containingListSel = listPacksSelIn;
        this.guiMobile = listPacksSelIn.getMobileGui();
    ...
    {
    	if(y < this.guiMobile.getScreenY()-3 ||
    	   y > this.guiMobile.getScreenY()+this.guiMobile.getScreenHeight())
    	return;
        ...
        this.client.renderEngine.bindTexture(GuiComputer.computerBg);
