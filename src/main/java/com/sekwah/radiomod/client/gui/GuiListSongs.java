...
public class GuiListSongs extends GuiListExtended
{
    private static final Logger LOGGER = LogManager.getLogger();
    private final GuiComputer guiComputer;
    private final List<GuiListSongsEntry> entries = Lists.<GuiListSongsEntry>newArrayList();
    /** Index to the currently selected pack */
    private int selectedIdx = -1;
    public float partialTicks = 0;
    
    public GuiListSongs(GuiComputer guiComputerIn, Minecraft clientIn, int widthIn, int heightIn, int topIn, int bottomIn)
    {
        super(clientIn, widthIn, heightIn, topIn, bottomIn, 28);
        this.guiComputer = guiComputerIn;
        this.left = (int) guiComputerIn.getScreenX();
    ...
    public GuiListSongsEntry getListEntry(int index)
    {
        return (GuiListSongsEntry)this.entries.get(index);
    }
    ...
    {
        return this.getX()+(int)this.guiComputer.getScreenWidth()-16;
    }
    
    public int getListWidth()
    {
        return (int) (this.getComputerGui().getScreenWidth()-20);
    }
    
    public void selectSong(int idx)
    {
        this.selectedIdx = idx;
        this.guiComputer.selectSong(this.getSelectedSongEntry());
    }
    ...
    public void drawScreen(int mouseXIn, int mouseYIn, float partialTicks)
    {
        ...
        if (this.visible)
        {
            ...
            Draw.drawYGradient(this.getComputerGui().getScreenX(), this.top, this.width, 20, 0, 0, 0, shadowOpacity*0.3f, 0, 0, 0, 0);
    ...
    public int getX() {
    	return (int) (this.getComputerGui().getScreenX()+10);
    }
