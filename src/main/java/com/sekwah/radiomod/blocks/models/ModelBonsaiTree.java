package com.sekwah.radiomod.blocks.models;
...
/**
 * Dont ask why this is here. Its just stolen from another of my mods to test rendering. It will be removed once raz
 * has some models :)
 */
public class ModelBonsaiTree extends ModelBase {
    //fields
